...
public final /* data */ class FilePathComponents {
    ...
    public boolean equals(Object r5) {
        ...
        if (!(r5 instanceof FilePathComponents)) {
            return false;
        }
        FilePathComponents filePathComponents = (FilePathComponents) r5;
