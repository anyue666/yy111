...
public final /* data */ class KTypeProjection {
    ...
    public boolean equals(Object r5) {
        ...
        if (!(r5 instanceof KTypeProjection)) {
            return false;
        }
        KTypeProjection kTypeProjection = (KTypeProjection) r5;
