...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final CharIterator iterator(CharSequence charSequence) {
        ...
        return new CharIterator() { // from class: kotlin.text.StringsKt__StringsKt$iterator$1
            ...
            StringsKt__StringsKt$iterator$1(CharSequence charSequence2) {
                r1 = charSequence2;
            }
    ...
    private static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(CharSequence charSequence, char[] cArr, int i, boolean z, int i2) {
        ...
        return new DelimitedRangesSequence(charSequence, i, i2, new Function2<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>>() { // from class: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$1
            ...
            StringsKt__StringsKt$rangesDelimitedBy$1(char[] cArr2, boolean z2) {
                super(2);
                r1 = cArr2;
                r2 = z2;
            }
            ...
            public final Pair<Integer, Integer> invoke(CharSequence $receiver, int i3) {
                ...
                int indexOfAny = StringsKt.indexOfAny($receiver, r1, i3, r2);
                if (indexOfAny < 0) {
                    return null;
                }
    ...
    private static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(CharSequence charSequence, String[] strArr, int i, boolean z, int i2) {
        ...
        return new DelimitedRangesSequence(charSequence, i, i2, new Function2<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>>() { // from class: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$2
            ...
            public final Pair<Integer, Integer> invoke(CharSequence $receiver, int i3) {
                ...
                Intrinsics.checkNotNullParameter($receiver, "$this$$receiver");
                findAnyOf$StringsKt__StringsKt = StringsKt__StringsKt.findAnyOf$StringsKt__StringsKt($receiver, r1, i3, r2, false);
                if (findAnyOf$StringsKt__StringsKt != null) {
    ...
    public static final Sequence<String> splitToSequence(CharSequence charSequence, String[] delimiters, boolean z, int i) {
        ...
        return SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence, delimiters, 0, z, i, 2, (Object) null), new Function1<IntRange, String>() { // from class: kotlin.text.StringsKt__StringsKt$splitToSequence$1
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            StringsKt__StringsKt$splitToSequence$1(CharSequence charSequence2) {
                super(1);
                r1 = charSequence2;
            }
            ...
            public final String invoke(IntRange it) {
                ...
                return StringsKt.substring(r1, it);
            }
        });
    }
    ...
    public static final Sequence<String> splitToSequence(CharSequence charSequence, char[] delimiters, boolean z, int i) {
        ...
        return SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence, delimiters, 0, z, i, 2, (Object) null), new Function1<IntRange, String>() { // from class: kotlin.text.StringsKt__StringsKt$splitToSequence$2
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            StringsKt__StringsKt$splitToSequence$2(CharSequence charSequence2) {
                super(1);
                r1 = charSequence2;
            }
