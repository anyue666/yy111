...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1447minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1593minusLRDsOJo(this, j);
    }
    ...
    public long mo1446elapsedNowUwyO8pc() {
        return Duration.m1492minusLRDsOJo(this.mark.mo1446elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1449plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1493plusLRDsOJo(this.adjustment, duration), null);
    }
}
