...
public interface TimeMark {
    ...
    TimeMark mo1447minusLRDsOJo(long r1);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1449plusLRDsOJo(long r1);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo */
        public static TimeMark m1594plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo */
        public static TimeMark m1593minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1449plusLRDsOJo(Duration.m1509unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1490isNegativeimpl(timeMark.mo1446elapsedNowUwyO8pc());
        }
