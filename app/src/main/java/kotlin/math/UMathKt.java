...
public final class UMathKt {
    ...
    private static final int m1355minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1337minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m1356mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1345minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m1353maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1325maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m1354maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1333maxOfeb3DHEI(j, j2);
    }
}
