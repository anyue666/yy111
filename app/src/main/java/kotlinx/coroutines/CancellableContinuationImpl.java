...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame {
    ...
    @Override // kotlin.coroutines.Continuation
    public void resumeWith(Object r8) {
        resumeImpl$default(this, CompletionStateKt.toState(r8, this), this.resumeMode, null, 4, null);
    }
    ...
    public void invokeOnCancellation(Function1<? super Throwable, Unit> handler) {
        ...
        while (true) {
            ...
            if (obj instanceof Active) {
                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, makeCancelHandler)) {
                    return;
                }
                ...
                if (obj instanceof CompletedContinuation) {
                    ...
                    if (completedContinuation.getCancelled()) {
                        ...
                        if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, makeCancelHandler, null, null, null, 29, null))) {
                            return;
                        }
                    }
                } else {
                    ...
                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, new CompletedContinuation(obj, makeCancelHandler, null, null, null, 28, null))) {
                        return;
                    }
                }
            }
