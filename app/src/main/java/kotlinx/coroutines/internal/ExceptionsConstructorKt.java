...
public final class ExceptionsConstructorKt {
    ...
    private static final Function1<Throwable, Throwable> createSafeConstructor(Constructor<?> constructor) {
        ...
        if (length == 0) {
            return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$4
                ...
                public ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$4(Constructor constructor2) {
                    super(1);
                    r1 = constructor2;
                }
                ...
                public final Throwable invoke(Throwable th) {
                    ...
                    try {
                        Result.Companion companion = Result.INSTANCE;
                        newInstance = r1.newInstance(new Object[0]);
                    } catch (Throwable th2) {
                        Result.Companion companion2 = Result.INSTANCE;
                    ...
                    if (newInstance != null) {
                        ...
                        th3.initCause(th);
                        m131constructorimpl = Result.m131constructorimpl(th3);
                        if (Result.m137isFailureimpl(m131constructorimpl)) {
                            m131constructorimpl = null;
                        }
        ...
        if (length != 1) {
            if (length == 2 && Intrinsics.areEqual(parameterTypes[0], String.class) && Intrinsics.areEqual(parameterTypes[1], Throwable.class)) {
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$1
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    public ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$1(Constructor constructor2) {
                        super(1);
                        r1 = constructor2;
                    }
                    ...
                    public final Throwable invoke(Throwable th) {
                        ...
                        try {
                            Result.Companion companion = Result.INSTANCE;
                            newInstance = r1.newInstance(th.getMessage(), th);
                        } catch (Throwable th2) {
                            Result.Companion companion2 = Result.INSTANCE;
                            m131constructorimpl = Result.m131constructorimpl(ResultKt.createFailure(th2));
                        }
        ...
        if (!Intrinsics.areEqual(cls, Throwable.class)) {
            if (Intrinsics.areEqual(cls, String.class)) {
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$3
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    public ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$3(Constructor constructor2) {
                        super(1);
                        r1 = constructor2;
                    }
                    ...
                    public final Throwable invoke(Throwable th) {
                        ...
                        try {
                            Result.Companion companion = Result.INSTANCE;
                            newInstance = r1.newInstance(th.getMessage());
                        } catch (Throwable th2) {
                            Result.Companion companion2 = Result.INSTANCE;
                            m131constructorimpl = Result.m131constructorimpl(ResultKt.createFailure(th2));
                        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$2
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$2(Constructor constructor2) {
                super(1);
                r1 = constructor2;
            }
    ...
    private static final Function1<Throwable, Throwable> safeCtor(Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                Object m131constructorimpl;
                Function1<Throwable, Throwable> function12 = r1;
                try {
                    Result.Companion companion = Result.INSTANCE;
                    m131constructorimpl = Result.m131constructorimpl(function12.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m131constructorimpl = Result.m131constructorimpl(ResultKt.createFailure(th2));
                }
