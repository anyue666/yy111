...
final class CombineKt$combineInternal$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
  ...
  0x00ec: PHI (r6v9 int) = (r6v8 int), (r6v10 int) binds: [B:14:0x00e7, B:38:?] A[DONT_GENERATE, DONT_INLINE]
  0x00ec: PHI (r10v5 kotlin.collections.IndexedValue) = (r10v4 kotlin.collections.IndexedValue), (r10v18 kotlin.collections.IndexedValue) binds: [B:14:0x00e7, B:38:?] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:30:0x0135 -> B:8:0x00c6). Please report as a decompilation issue!!! */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (i == 0) {
                    ...
                    this.label = 1;
                    if (this.$flows[this.$i].collect(new C00091(this.$resultChannel, this.$i), this) == coroutine_suspended) {
