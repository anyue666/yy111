    ...
    */
    ...
    public final Object mo1638trySendJP2dKIU(E element) {
        ...
        if (offerInternal instanceof Closed) {
            return ChannelResult.INSTANCE.m1656closedJP2dKIU(helpCloseAndGetSendException((Closed) offerInternal));
        }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m131constructorimpl(ResultKt.createFailure(undeliveredElementException)));
            return;
        }
    ...
    protected Object enqueueSend(Send send) {
        ...
        AbstractSendChannel$enqueueSend$$inlined$addLastIfPrevAndIf$1 abstractSendChannel$enqueueSend$$inlined$addLastIfPrevAndIf$1 = new LockFreeLinkedListNode.CondAddOp(this) { // from class: kotlinx.coroutines.channels.AbstractSendChannel$enqueueSend$$inlined$addLastIfPrevAndIf$1
            ...
            public AbstractSendChannel$enqueueSend$$inlined$addLastIfPrevAndIf$1(AbstractSendChannel this) {
    ...
    */
    ...
    public final SelectClause2<E, SendChannel<E>> getOnSend() {
        return new SelectClause2<E, SendChannel<? super E>>(this) { // from class: kotlinx.coroutines.channels.AbstractSendChannel$onSend$1
            ...
            AbstractSendChannel$onSend$1(AbstractSendChannel<E> this) {
                this.this$0 = this;
            }
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m131constructorimpl(Unit.INSTANCE));
                break;
            }
            if (offerInternal != AbstractChannelKt.OFFER_FAILED) {
                if (offerInternal instanceof Closed) {
