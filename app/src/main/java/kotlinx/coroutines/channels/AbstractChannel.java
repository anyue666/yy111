...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final java.lang.Object mo1636receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L32:
            ...
            java.lang.Object r5 = r0.m1656closedJP2dKIU(r5)
            goto L52
        L4c:
            kotlinx.coroutines.channels.ChannelResult$Companion r0 = kotlinx.coroutines.channels.ChannelResult.INSTANCE
            java.lang.Object r5 = r0.m1658successJP2dKIU(r5)
        L52:
            return r5
        L53:
            r0.label = r3
        ...
        L5c:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo1636receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public final Object mo1637tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1657failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.INSTANCE.m1656closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.INSTANCE.m1658successJP2dKIU(pollInternal);
    }
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                mo1635onCancelIdempotentListww6eGU(m1674constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            if (i != 1) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1643boximpl(z ? companion.m1656closedJP2dKIU(((Closed) obj).closeCause) : companion.m1658successJP2dKIU(obj)), selectInstance.getCompletion());
                return;
            }
        }
        if (i == 0) {
        ...
        if (i == 1 && selectInstance.trySelect()) {
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1643boximpl(ChannelResult.INSTANCE.m1656closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
        }
    }
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m131constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.INSTANCE;
                        cancellableContinuationImpl.resumeWith(Result.m131constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
                } else if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                    Boolean boxBoolean = Boxing.boxBoolean(true);
                    Function1<E, Unit> function1 = this.channel.onUndeliveredElement;
                    cancellableContinuationImpl.resume(boxBoolean, function1 == null ? null : OnUndeliveredElementKt.bindCancellationFun(function1, pollInternal, cancellableContinuationImpl.get$context()));
                }
            }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m131constructorimpl(ChannelResult.m1643boximpl(ChannelResult.INSTANCE.m1656closedJP2dKIU(closed.closeCause))));
            }
        }
