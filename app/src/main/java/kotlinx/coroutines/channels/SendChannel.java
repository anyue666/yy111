...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1638trySendJP2dKIU = sendChannel.mo1638trySendJP2dKIU(e);
            if (ChannelResult.m1653isSuccessimpl(mo1638trySendJP2dKIU)) {
                return true;
            }
            Throwable m1647exceptionOrNullimpl = ChannelResult.m1647exceptionOrNullimpl(mo1638trySendJP2dKIU);
