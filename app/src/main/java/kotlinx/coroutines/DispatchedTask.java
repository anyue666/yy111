        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m131constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    T successfulResult$kotlinx_coroutines_core = getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core);
                    Result.Companion companion3 = Result.INSTANCE;
                    continuation.resumeWith(Result.m131constructorimpl(successfulResult$kotlinx_coroutines_core));
                }
                ...
                try {
                    ...
                    m131constructorimpl2 = Result.m131constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.INSTANCE;
                    m131constructorimpl2 = Result.m131constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException(null, Result.m134exceptionOrNullimpl(m131constructorimpl2));
            } finally {
            ...
            handleFatalException(th2, Result.m134exceptionOrNullimpl(m131constructorimpl));
        }
    }
