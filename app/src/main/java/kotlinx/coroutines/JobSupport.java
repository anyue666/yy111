...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    private final Object finalizeFinishingState(Finishing state, Object proposedUpdate) {
        ...
        boolean m = LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, state, JobSupportKt.boxIncomplete(proposedUpdate));
    ...
    private final boolean tryFinalizeSimpleState(Incomplete state, Object r6) {
        if (DebugKt.getASSERTIONS_ENABLED()) {
            if (!((state instanceof Empty) || (state instanceof JobNode))) {
                throw new AssertionError();
            }
        }
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(r6 instanceof CompletedExceptionally))) {
            throw new AssertionError();
        }
        if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, state, JobSupportKt.boxIncomplete(r6))) {
            return false;
        }
        onCancelling(null);
        onCompletionInternal(r6);
        completeStateFinalization(state, r6);
        return true;
    }

    private final void completeStateFinalization(Incomplete state, Object r5) {
        ChildHandle parentHandle$kotlinx_coroutines_core = getParentHandle$kotlinx_coroutines_core();
        if (parentHandle$kotlinx_coroutines_core != null) {
            parentHandle$kotlinx_coroutines_core.dispose();
            setParentHandle$kotlinx_coroutines_core(NonDisposableHandle.INSTANCE);
        }
        CompletedExceptionally completedExceptionally = r5 instanceof CompletedExceptionally ? (CompletedExceptionally) r5 : null;
    ...
    private final int startInternal(Object state) {
        ...
        if (state instanceof Empty) {
            ...
            if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, state, empty)) {
                return -1;
            }
            onStart();
            return 1;
        ...
        while (true) {
            ...
            if (state$kotlinx_coroutines_core instanceof Empty) {
                ...
                if (empty.getIsActive()) {
                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, state$kotlinx_coroutines_core, makeNode)) {
                        return makeNode;
                    }
                } else {
    ...
    private final boolean addLastAtomic(Object expect, NodeList list, JobNode node) {
        ...
        JobSupport$addLastAtomic$$inlined$addLastIf$1 jobSupport$addLastAtomic$$inlined$addLastIf$1 = new LockFreeLinkedListNode.CondAddOp(this, expect) { // from class: kotlinx.coroutines.JobSupport$addLastAtomic$$inlined$addLastIf$1
            final /* synthetic */ Object $expect$inlined;
            final /* synthetic */ JobSupport this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public JobSupport$addLastAtomic$$inlined$addLastIf$1(JobSupport this, Object expect2) {
                super(LockFreeLinkedListNode.this);
                this.this$0 = this;
                this.$expect$inlined = expect2;
            }
    ...
    public final void removeNode$kotlinx_coroutines_core(JobNode node) {
        ...
        do {
            ...
            empty = JobSupportKt.EMPTY_ACTIVE;
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, state$kotlinx_coroutines_core, empty));
    }
