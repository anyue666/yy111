...
public final class MutexImpl implements Mutex, SelectClause2<Object, Mutex> {
    ...
    private static final class TryLockDesc extends AtomicDesc {
        ...
        public Object prepare(AtomicOp<?> op) {
            ...
            if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, mutexImpl, empty, prepareOp)) {
    ...
    public void unlock(Object owner) {
        ...
        while (true) {
            ...
            if (obj instanceof Empty) {
                ...
                empty = MutexKt.EMPTY_UNLOCKED;
                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, obj, empty)) {
                    return;
                }
