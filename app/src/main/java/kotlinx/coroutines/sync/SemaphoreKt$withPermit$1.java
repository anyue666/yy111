...
@DebugMetadata(c = "kotlinx.coroutines.sync.SemaphoreKt", f = "Semaphore.kt", i = {0, 0}, l = {85}, m = "withPermit", n = {"$this$withPermit", CarUserManager.BUNDLE_PARAM_ACTION}, s = {"L$0", "L$1"})
