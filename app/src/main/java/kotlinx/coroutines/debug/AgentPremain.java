...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m131constructorimpl = Result.m131constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
    ...
    public static final void m1660installSignalHandler$lambda1(Signal signal) {
