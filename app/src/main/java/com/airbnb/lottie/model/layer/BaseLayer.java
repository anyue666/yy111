    ...
    private void setupInOutAnimations() {
        if (!this.layerModel.getInOutKeyframes().isEmpty()) {
            ...
            floatKeyframeAnimation.addUpdateListener(new BaseKeyframeAnimation.AnimationListener() { // from class: com.airbnb.lottie.model.layer.BaseLayer.1
                ...
                AnonymousClass1(FloatKeyframeAnimation floatKeyframeAnimation2) {
                    r2 = floatKeyframeAnimation2;
                }

                @Override // com.airbnb.lottie.animation.keyframe.BaseKeyframeAnimation.AnimationListener
                public void onValueChanged() {
                    BaseLayer.this.setVisible(r2.getFloatValue() == 1.0f);
                }
            });
            setVisible(floatKeyframeAnimation2.getValue().floatValue() == 1.0f);
            addAnimation(floatKeyframeAnimation2);
            return;
        }
        setVisible(true);
    }
