...
final class LinearIndeterminateDisjointAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private static final int[] DURATION_TO_MOVE_SEGMENT_ENDS = {ALVehicleControlProperty.VEHICLE_PROPERTY_VC_VENDOR_FR_WINDOW, ALVehicleControlProperty.VEHICLE_PROPERTY_VC_VENDOR_PASSENGER_SEAT_FR, 850, ALVehicleControlProperty.VEHICLE_PROPERTY_DVR_IHU_DATA5_T1L};
