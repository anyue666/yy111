...
public class NowDataBean implements Parcelable {
    public static final Parcelable.Creator<NowDataBean> CREATOR = new Parcelable.Creator<NowDataBean>() { // from class: com.autolink.hmi.crosscountry.bean.NowDataBean.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public NowDataBean createFromParcel(Parcel parcel) {
            return new NowDataBean(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public NowDataBean[] newArray(int i) {
            return new NowDataBean[i];
        }
    };
    ...
    protected NowDataBean(Parcel parcel) {
