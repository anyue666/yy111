...
public final class PropertyPermissionMapping {
    ...
    public PropertyPermissionMapping() {
        ...
        map(Car.PERMISSION_CONTROL_CAR_CLIMATE, 356517120, 356517121, 358614274, 358614275, 320865540, 354419973, 354419974, 354419975, 354419976, 354419977, 354419978, 356517131, 339739916, 289408269, 289408270, 356517135, 354419984, 356582673, 354419986, 356517139);
