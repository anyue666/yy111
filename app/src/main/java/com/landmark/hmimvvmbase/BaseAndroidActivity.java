...
/* compiled from: BaseAndroidActivity.kt */
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u000b\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b&\u0018\u0000*\b\b\u0000\u0010\u0001*\u00020\u0002*\b\b\u0001\u0010\u0003*\u00020\u00042\u00020\u00052\u000e\u0012\u0004\u0012\u0002H\u0001\u0012\u0004\u0012\u0002H\u00030\u0006B\u0005¢\u0006\u0002\u0010\u0007J\u0012\u0010\u0011\u001a\u00020\u00122\b\u0010\u0013\u001a\u0004\u0018\u00010\u0014H\u0014J\b\u0010\u0015\u001a\u00020\u0012H\u0014J\b\u0010\u0016\u001a\u00020\u0012H\u0014R\u001b\u0010\b\u001a\u00028\u00008VX\u0096\u0084\u0002¢\u0006\f\n\u0004\b\u000b\u0010\f\u001a\u0004\b\t\u0010\nR\u001b\u0010\r\u001a\u00028\u00018VX\u0096\u0084\u0002¢\u0006\f\n\u0004\b\u0010\u0010\f\u001a\u0004\b\u000e\u0010\u000f¨\u0006\u0017"}, d2 = {"Lcom/landmark/hmimvvmbase/BaseAndroidActivity;", "VB", "Landroidx/databinding/ViewDataBinding;", "VM", "Lcom/landmark/hmimvvmbase/BaseAndroidViewModel;", "Lcom/landmark/hmibase/LandmarkActivity;", "Lcom/landmark/hmimvvmbase/IBaseComponents;", "()V", "mVB", "getMVB", "()Landroidx/databinding/ViewDataBinding;", "mVB$delegate", "Lkotlin/Lazy;", "mVM", "getMVM", "()Lcom/landmark/hmimvvmbase/BaseAndroidViewModel;", "mVM$delegate", "onCreate", "", "savedInstanceState", "Landroid/os/Bundle;", "onDestroy", "onRestart", "hmiMvvmBase_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
/* loaded from: classes.dex */
public abstract class BaseAndroidActivity<VB extends ViewDataBinding, VM extends BaseAndroidViewModel> extends LandmarkActivity implements IBaseComponents<VB, VM> {

    /* renamed from: mVB$delegate, reason: from kotlin metadata */
    private final Lazy mVB = LazyKt.lazy(new Function0<VB>(this) { // from class: com.landmark.hmimvvmbase.BaseAndroidActivity$mVB$2
        final /* synthetic */ BaseAndroidActivity<VB, VM> this$0;
        ...
        public final ViewDataBinding invoke() {
            BaseAndroidActivity<VB, VM> baseAndroidActivity = this.this$0;
            ViewDataBinding contentView = DataBindingUtil.setContentView(baseAndroidActivity, baseAndroidActivity.onLayoutId(baseAndroidActivity));
    ...
    private final Lazy mVM = LazyKt.lazy(new Function0<VM>(this) { // from class: com.landmark.hmimvvmbase.BaseAndroidActivity$mVM$2
        final /* synthetic */ BaseAndroidActivity<VB, VM> this$0;
        ...
        public final BaseAndroidViewModel invoke() {
            ...
            if (genericSuperclass instanceof ParameterizedType) {
                ...
                Intrinsics.checkNotNull(viewModel, "null cannot be cast to non-null type VM of com.landmark.hmimvvmbase.BaseAndroidActivity");
            ...
            Intrinsics.checkNotNull(viewModel2, "null cannot be cast to non-null type VM of com.landmark.hmimvvmbase.BaseAndroidActivity");
