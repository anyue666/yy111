...
public final class SavedStateHandle {
    ...
    public static final Bundle m58savedStateProvider$lambda0(SavedStateHandle this$0) {
    ...
    public SavedStateHandle(Map<String, ? extends Object> initialState) {
        ...
        this.savedStateProvider = new SavedStateRegistry.SavedStateProvider() { // from class: androidx.lifecycle.SavedStateHandle$$ExternalSyntheticLambda0
            ...
            public final Bundle saveState() {
                Bundle m58savedStateProvider$lambda0;
                m58savedStateProvider$lambda0 = SavedStateHandle.m58savedStateProvider$lambda0(SavedStateHandle.this);
                return m58savedStateProvider$lambda0;
            }
        };
