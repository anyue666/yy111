...
public final class ViewDataBindingKtx {
    ...
    private static final CreateWeakListener CREATE_STATE_FLOW_LISTENER = new CreateWeakListener() { // from class: androidx.databinding.ViewDataBindingKtx$$ExternalSyntheticLambda0
        ...
        public final WeakListener create(ViewDataBinding viewDataBinding, int i, ReferenceQueue referenceQueue) {
            WeakListener m56CREATE_STATE_FLOW_LISTENER$lambda0;
            m56CREATE_STATE_FLOW_LISTENER$lambda0 = ViewDataBindingKtx.m56CREATE_STATE_FLOW_LISTENER$lambda0(viewDataBinding, i, referenceQueue);
            return m56CREATE_STATE_FLOW_LISTENER$lambda0;
        }
    };
    ...
    public static final WeakListener m56CREATE_STATE_FLOW_LISTENER$lambda0(ViewDataBinding viewDataBinding, int i, ReferenceQueue referenceQueue) {
