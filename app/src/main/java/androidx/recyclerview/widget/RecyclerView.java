    ...
    */
        ...
        */
        ...
        void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if ((RecyclerView.this.mAdapter != null && doesTransientStatePreventRecycling && RecyclerView.this.mAdapter.onFailedToRecycleView(viewHolder)) || viewHolder.isRecyclable()) {
                if (this.mViewCacheMax <= 0 || viewHolder.hasAnyOfTheFlags(ALVehicleControlProperty.VEHICLE_PROPERTY_VC_VENDOR_MIRROR_HOLD_SWITCH)) {
                    z = false;
                } else {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(VH vh, int i) {
            ...
            vh.setFlags(1, ALVehicleControlProperty.VEHICLE_PROPERTY_VC_RCW);
    ...
    int getAdapterPositionFor(ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags(ALVehicleControlProperty.VEHICLE_PROPERTY_VC_VENDOR_AVH) || !viewHolder.isBound()) {
            return -1;
        }
