...
public final class OnBackPressedDispatcher {
        ...
        if (BuildCompat.isAtLeastT()) {
            this.mEnabledConsumer = new Consumer() { // from class: androidx.activity.OnBackPressedDispatcher$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    OnBackPressedDispatcher.this.m18lambda$new$0$androidxactivityOnBackPressedDispatcher((Boolean) obj);
                }
            };
    ...
    /* synthetic */ void m18lambda$new$0$androidxactivityOnBackPressedDispatcher(Boolean bool) {
        if (BuildCompat.isAtLeastT()) {
            updateBackInvokedCallbackState();
        }
    }
