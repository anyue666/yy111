    ...
    class Model {
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str3 = SystemContact.VOICE_AREA_PARTITION;
                StringBuilder append = new StringBuilder().append(((constraintAnchor != null ? "T" : SystemContact.VOICE_AREA_PARTITION) + (constraintWidget.mBottom.mTarget != null ? "B" : SystemContact.VOICE_AREA_PARTITION)) + (constraintWidget.mLeft.mTarget != null ? "L" : SystemContact.VOICE_AREA_PARTITION));
