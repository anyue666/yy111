...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            canvas.drawRGB(ALHvacVehicleProperty.VEHICLE_PROPERTY_HVAC_FL_HEAT, ALHvacVehicleProperty.VEHICLE_PROPERTY_HVAC_FL_HEAT, ALHvacVehicleProperty.VEHICLE_PROPERTY_HVAC_FL_HEAT);
            Paint paint = new Paint();
            paint.setARGB(255, ALHvacVehicleProperty.VEHICLE_PROPERTY_HVAC_OUT_PM25, ALHvacVehicleProperty.VEHICLE_PROPERTY_HVAC_OUT_PM25, ALHvacVehicleProperty.VEHICLE_PROPERTY_HVAC_OUT_PM25);
