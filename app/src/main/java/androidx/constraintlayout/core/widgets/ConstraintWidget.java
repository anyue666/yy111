...
public class ConstraintWidget {
    ...
    public StringBuilder serialize(StringBuilder sb) {
        ...
        serializeAnchor(sb, CarUxRestrictionsManager.UX_RESTRICTION_MODE_BASELINE, this.mBaseline);
    ...
    */
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        getSceneString(sb, CarUxRestrictionsManager.UX_RESTRICTION_MODE_BASELINE, this.mBaseline);
