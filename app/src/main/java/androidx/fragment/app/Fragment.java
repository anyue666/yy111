...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    void callStartTransitionListener(boolean z) {
        ...
        if (z) {
            this.mHost.getHandler().post(new Runnable() { // from class: androidx.fragment.app.Fragment.3
                ...
                AnonymousClass3(SpecialEffectsController orCreateController2) {
    ...
    public final <I, O> ActivityResultLauncher<I> registerForActivityResult(ActivityResultContract<I, O> activityResultContract, ActivityResultRegistry activityResultRegistry, ActivityResultCallback<O> activityResultCallback) {
        return prepareCallInternal(activityResultContract, new Function<Void, ActivityResultRegistry>() { // from class: androidx.fragment.app.Fragment.7
            ...
            AnonymousClass7(ActivityResultRegistry activityResultRegistry2) {
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(ActivityResultContract<I, O> activityResultContract, Function<Void, ActivityResultRegistry> function, ActivityResultCallback<O> activityResultCallback) {
        ...
        registerOnPreAttachListener(new OnPreAttachedListener() { // from class: androidx.fragment.app.Fragment.8
            ...
            AnonymousClass8(Function function2, AtomicReference atomicReference2, ActivityResultContract activityResultContract2, ActivityResultCallback activityResultCallback2) {
                super();
                r2 = function2;
                r3 = atomicReference2;
        ...
        return new ActivityResultLauncher<I>() { // from class: androidx.fragment.app.Fragment.9
            ...
            AnonymousClass9(AtomicReference atomicReference2, ActivityResultContract activityResultContract2) {
                r2 = atomicReference2;
