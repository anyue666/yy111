...
public class ContextCompat {
    ...
    private static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            hashMap.put(BluetoothManager.class, CarPageContact.BLUETOOTH);
            ...
            hashMap.put(LocationManager.class, Constant.MY_LOCATION);
            hashMap.put(NfcManager.class, "nfc");
            hashMap.put(NotificationManager.class, "notification");
            hashMap.put(PowerManager.class, "power");
            hashMap.put(SearchManager.class, "search");
            hashMap.put(SensorManager.class, Car.SENSOR_SERVICE);
            ...
            hashMap.put(WindowManager.class, CarPageContact.WINDOW);
        }
    }
