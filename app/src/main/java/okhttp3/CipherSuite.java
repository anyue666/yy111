...
public final class CipherSuite {
    ...
    public static final CipherSuite TLS_PSK_WITH_RC4_128_SHA = init("TLS_PSK_WITH_RC4_128_SHA", ALHvacVehicleProperty.VEHICLE_PROPERTY_HVAC_FL_HEAT_AND_WIND);
    public static final CipherSuite TLS_PSK_WITH_3DES_EDE_CBC_SHA = init("TLS_PSK_WITH_3DES_EDE_CBC_SHA", ALHvacVehicleProperty.VEHICLE_PROPERTY_HVAC_FR_HEAT_AND_WIND);
    public static final CipherSuite TLS_PSK_WITH_AES_128_CBC_SHA = init("TLS_PSK_WITH_AES_128_CBC_SHA", ALHvacVehicleProperty.VEHICLE_PROPERTY_HVAC_CUSTOM);
    public static final CipherSuite TLS_PSK_WITH_AES_256_CBC_SHA = init("TLS_PSK_WITH_AES_256_CBC_SHA", ALHvacVehicleProperty.VEHICLE_PROPERTY_HVAC_AUTO_VENTILATION);
