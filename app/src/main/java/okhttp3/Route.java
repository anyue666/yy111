...
public final class Route {
    ...
    public int hashCode() {
        return ((((ALVehicleControlProperty.VEHICLE_PROPERTY_VC_VENDOR_MIRROR_FLIP + this.address.hashCode()) * 31) + this.proxy.hashCode()) * 31) + this.inetSocketAddress.hashCode();
    }
