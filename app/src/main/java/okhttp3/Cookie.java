...
public final class Cookie {
    ...
    */
    ...
    private static long parseExpires(String str, int i, int i2) {
        ...
        if (i3 >= 0 && i3 <= 69) {
            i3 += KeyCodeExt.KEYCODE_AL_R_LEFT;
        }
        if (i3 < 1601) {
    ...
    public int hashCode() {
        int hashCode = (((((((ALVehicleControlProperty.VEHICLE_PROPERTY_VC_VENDOR_MIRROR_FLIP + this.name.hashCode()) * 31) + this.value.hashCode()) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31;
