    ...
    */
    ...
    RealWebSocket.Streams newWebSocketStreams(Exchange exchange) throws SocketException {
        ...
        return new RealWebSocket.Streams(true, this.source, this.sink) { // from class: okhttp3.internal.connection.RealConnection.1
            ...
            AnonymousClass1(boolean z, BufferedSource bufferedSource, BufferedSink bufferedSink, Exchange exchange2) {
            ...
            public void close() throws IOException {
                r5.bodyComplete(-1L, true, true, null);
            }
        };
    }
    ...
    public String toString() {
        ...
        return append.append(handshake != null ? handshake.cipherSuite() : SchedulerSupport.NONE).append(" protocol=").append(this.protocol).append('}').toString();
    }
}
