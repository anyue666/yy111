...
public final class RealConnectionPool {
    ...
    private final Runnable cleanupRunnable = new Runnable() { // from class: okhttp3.internal.connection.RealConnectionPool$$ExternalSyntheticLambda0
        ...
        public final void run() {
            RealConnectionPool.this.m1697lambda$new$0$okhttp3internalconnectionRealConnectionPool();
        }
    };
    ...
    /* synthetic */ void m1697lambda$new$0$okhttp3internalconnectionRealConnectionPool() {
        while (true) {
